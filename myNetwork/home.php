	...
	<div class="profile-sidebar">
		...
		<div class="col-md-9">
            <div class="profile-content">
			  <div class="well"> 
                                   <form action="home.php?id=<?php echo $user_id; ?>" method="POST" class="form-horizontal" role="form">
                                    <h4>What's New</h4>
                                     <div class="form-group" style="padding:14px;">
                                     <input class="form-control" type="text" name="title" placeholder="Write what's the reason?" required>
                                      <br>
                                      <textarea class="form-control" placeholder="Update your status" name="content" required></textarea>
                                      <br>
                                    ...
                                    <br>
                                    <button class="btn btn-primary pull-right" type="submit" name='sub'> Post </button><ul class="list-inline"><li><a href=""></ul>
                                      </div>
                                  </form>
                                  <?php insertPost();?>
                              </div>
